...
```
    As you see down in Massages Section, it shows that the password is weak, just do not worry.
 ```
...
- If this Window popped, just click `Allow access`, and wait until the installation finishes. 
